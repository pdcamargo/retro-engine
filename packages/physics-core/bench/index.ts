// Bench runner entry for @retro-engine/physics-core. Pretty-prints mitata's
// default summary unless `--json` is passed, in which case the normalized
// snapshot (see docs/adr/ADR-0017 for schema) is written to stdout.
//
// Usage:
...
if (wantJson) {
  ...
  const report: NormalizedReport = {
    schema: 1,
    package: '@retro-engine/physics-core',
