// Bench runner entry for @retro-engine/ecs. Pretty-prints mitata's default
...
//   bun run bench/index.ts --filter q  # mitata filter regex applied to bench names

import { run } from 'mitata';

import './query.bench';
import './spawn-despawn.bench';
import './change-detection.bench';
